...
namespace HotelVR.WebApp.Infrastructure.Extensions
{
    public static class LocalStorageExtension
    {
        ...
        // Role için metotlar
        public static string GetRole(this ISyncLocalStorageService localStorageService)
        {
            return localStorageService.GetItem<string>(Role);
        }

        public static async Task<string> GetRole(this ILocalStorageService localStorageService)
        {
            return await localStorageService.GetItemAsync<string>(Role);
        }

        public static void SetRole(this ISyncLocalStorageService localStorageService, string value)
        {
            localStorageService.SetItem(Role, value);
        }

        public static async Task SetRole(this ILocalStorageService localStorageService, string value)
        {
            await localStorageService.SetItemAsync(Role, value);
        }
